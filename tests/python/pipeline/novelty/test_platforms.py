...
from intruder.pipeline.novelty.platforms import (
    ANNOTATION_COLUMNS,
    CATALOG_COLUMNS,
    PLATFORMS,
    canonical_motifs,
...
def test_every_platform_declares_a_readable_format():
    from intruder.pipeline.novelty.platforms import READERS
...
def test_default_cache_is_the_repo_data_directory():
    ...
    from intruder.pipeline.novelty.platforms import default_cache
    cache = default_cache()
...
def test_the_cache_env_var_wins(monkeypatch, tmp_path):
    from intruder.pipeline.novelty.platforms import CACHE_ENV, default_cache
...
def test_platform_paths_follow_the_cache_directory(tmp_path):
    from intruder.pipeline.novelty.platforms import get_platform
