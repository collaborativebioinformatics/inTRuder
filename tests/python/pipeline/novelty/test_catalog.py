...
from intruder.pipeline.novelty.catalog import STATUSES, RepeatCatalog
from intruder.trcore.coords import to_external, to_internal
from intruder.trcore.motifs import MotifEquivalence, MotifTolerance
...
def test_repeat_filter_decides_what_counts_as_annotation(catalog):
    ...
    from intruder.pipeline.novelty.catalog import RepeatFilter
