...
*Generated 2026-08-28 17:57 UTC by `src/python/reporting/population_report.py` from `/Users/liedeweivandevondel/Documents/Work/Experiments_Miami/BCM_hackathon/05_hprc_multisample.tsv` (162,441 TRF calls across 17,270 loci; locus = chrom+position, not SVID -- see [novelty_by_allele_count.md](novelty_by_allele_count.md)).*
...
![Calls by novelty class](assets/population_distributions_full67/novelty_counts.png)
...
![Motif length by novelty class](assets/population_distributions_full67/motif_length.png)
...
![Repeat tract length by novelty class](assets/population_distributions_full67/rep_length.png)
...
![Purity by novelty class](assets/population_distributions_full67/purity.png)
...
![GC content by novelty class](assets/population_distributions_full67/gc_content.png)
