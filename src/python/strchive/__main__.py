...
"""Command line entry point for the STRchive comparison step.
    ...
    python -m strchive fetch

    # screen one candidate
    python -m strchive query --chrom chr1 --pos 94418430 --motif CCG --rep-units 120

    # annotate a whole table from the upstream filtering step
    python -m strchive annotate filtered.tsv annotated.tsv --window 500
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m strchive", description=__doc__,
