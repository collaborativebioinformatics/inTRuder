"""Annotate a VCF with the compressibility of each ALT allele.

Writes an ``SVCOMP`` INFO field holding raw-bytes / zlib-compressed-bytes per
ALT. A repetitive insertion compresses well and scores high; a random one sits
near 1. See docs/scripts/annotate_compression.md for the thresholds.
"""
