...
#
#     scripts/dx-instance-cpu.sh                    # a shell, for 2h at most
#     scripts/dx-instance-cpu.sh --time 30m
#     scripts/dx-instance-cpu.sh -f /survivor/HPRC_SV.survivor.vcf
#
...
# program and come straight back, use scripts/dx-batch-cpu.sh.
#
