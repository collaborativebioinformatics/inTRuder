...
# variables and sources this, which hands everything to
# scripts/dnanexus/dx-instance.sh.
#
...
Every scripts/dnanexus/dx-instance.sh option is accepted here and passed
straight through; \`scripts/dnanexus/dx-instance.sh --help\` documents all of
them. The ones you will reach for:
...
export DX_WRAPPER_NAME="scripts/dnanexus/$_dx_wrap_self"
exec "$_dx_wrap_repo/scripts/dnanexus/dx-instance.sh" "${_dx_wrap_flags[@]}" "$@"
