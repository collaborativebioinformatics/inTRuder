...
#
#     scripts/dx-instance-gpu.sh                    # a shell, for 2h at most
#     scripts/dx-instance-gpu.sh --time 4h
#     scripts/dx-instance-gpu.sh --sync-args "--group dx"
#
...
# can actually launch; `scripts/dx-instance.sh --list-instances gpu` is the
...
# program and come straight back, use scripts/dx-batch-gpu.sh.
#
